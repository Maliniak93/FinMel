...
| `skarbiec-plan/06-adr-decisions.md` | 16 ADRs — check before any architectural change |
...
- C# 14 / .NET 10: nullable enabled, file-scoped namespaces, records for DTOs/events/contracts, `sealed` by default; Minimal APIs with `TypedResults`; all errors as ProblemDetails.
