...
2. Create the slice folder containing:
   - `<FeatureName>Endpoint.cs` — Minimal API endpoint, registered in the service's endpoint mapping
   - `<FeatureName>Handler.cs` — plain class resolved from DI (no MediatR)
